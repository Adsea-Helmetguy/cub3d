...
typedef struct s_game
{
	...
	// images for textures
	int				**textures;
	int texture_width[4];  //*texture_width;
	int texture_height[4]; //*texture_height
							//
	int				error_code;
	int				screen_x;
	int				screen_y;
...
// floodfill.c
void				map_floodfill(char ***tmp_map, t_game *game, int p_x,
						int p_y);
void				map_floodfill2(char ***tmp_map, t_game *game, int p_x,
						int p_y);
...
//------------------------------void	render(t_game *game, int ray,
							...
							void
							window_screen_creation(t_game *game);
// texture.c
...
// exit_function.c
void				free_gameloop_end(char *message, int exit_code,
						t_game *game);
void				free_end_exit(char *message, int exit_code, t_game *game,
						char **str);
void				free_before_game(char *message, int exit_code,
						t_game *game);
